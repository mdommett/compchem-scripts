...
nproc = "%nproc=4"
mem = "%mem=28GB"
input_line = "#p ONIOM(wb97xd/6311++G**:UFF=:qQEq)=(EmbedCharge) nosymm"
...
for atom in final_cluster[natoms:]:
    ...
    comfile.write(atomStr)
comfile.write("\n--link1--\n")
input_line="#p ONIOM(wb97xd/6311++G** td=(nstates=3):UFF=:qQEq)=(EmbedCharge) geom=check guess=read nosymm"
comfile.write("{0}\n{1}\n{2}\n{3}\n\n Title \n\n0 1\n\n".format(chk,nproc,mem,input_line))
